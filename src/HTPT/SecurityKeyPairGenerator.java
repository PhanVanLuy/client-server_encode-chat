...
public class SecurityKeyPairGenerator {
    private static String urlPublicKey = "Publickey.dat";
    private static String urlPrivateKey = "Privatekey.dat";

    public static String getUrlPublicKey() {
        return urlPublicKey;
    }

    public static String getUrlPrivateKey() {
	...
	File publicKeyFile = createKeyFile(new File(urlPublicKey));
	File privateKeyFile = createKeyFile(new File(urlPrivateKey));
	// Lưu Public Key
